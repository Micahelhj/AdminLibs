...
public class ABViewUtil {
     ...
     *
     * @param contentView the ViewGroup
     */
     ...
     * @param widthPixels  View的PX宽度
     * @param heightPixels View的PX高度
     */
    public static void setViewSize(View view, int widthPixels, int heightPixels) {
        ...
        if (params == null) {
            ABLogUtil.e("setViewSize出错,如果是代码new出来的View，需要设置一个适合的LayoutParams");
            return;
        }
