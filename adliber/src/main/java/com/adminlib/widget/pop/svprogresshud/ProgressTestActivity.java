package com.adminlib.widget.pop.svprogresshud;
...
//        SVProgressHUD.showWithMaskType(this, SVProgressHUD.SVProgressHUDMaskType.GradientCancel);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            progress = progress + 5;
            if (SVProgressHUD.getProgressBar(ProgressTestActivity.this).getMax() != SVProgressHUD.getProgressBar(ProgressTestActivity.this).getProgress()) {
                SVProgressHUD.getProgressBar(ProgressTestActivity.this).setProgress(progress);
                SVProgressHUD.setText(ProgressTestActivity.this, "进度 " + progress + "%");

                mHandler.sendEmptyMessageDelayed(0, 500);
            } else {
                SVProgressHUD.dismiss(ProgressTestActivity.this);
                SVProgressHUD.getProgressBar(ProgressTestActivity.this).setProgress(0);
            }
